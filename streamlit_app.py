...
def add_bg_from_url():
        st.markdown(
            f"""
             <style>
             .stApp {{
                 background-image: url('https://images.squarespace-cdn.com/content/v1/52d6d1ede4b0b322e9c7a2ea/777ac661-f0e6-4ed1-8636-050741719eda/compare-fibre-YS_FCbcD5KM-unsplash.jpg?format=1500w');
